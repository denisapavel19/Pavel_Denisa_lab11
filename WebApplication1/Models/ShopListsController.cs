...
namespace WebApplication1.Models
{
    ...
    public class ShopListsController : ControllerBase
    {
        ...
        public ShopListsController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<ShopList>> PostShopList(ShopList shopList)
        {
          if (_context.ShopList == null)
          {
              return Problem("Entity set 'WebApplication1Context.ShopList'  is null.");
          }
        ...
        {
            return (_context.ShopList?.Any(e => e.ID == id)).GetValueOrDefault();
        }
    }
}
